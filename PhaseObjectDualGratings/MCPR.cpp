...
//  vector<double> dIfiltered = avgFilter(dI, pxlFilter); // Intensity filtered by pixel
	...
	// Output file
	printVector(dIblank,"dIblank_D12mm_");
	printVector(dIobj,"dIobj_D12mm_");
	printVector(dGrid,"dGrid_D12mm_");
	printVector(objectAll,"objectAll_D12mm_");
	printVector(G1.gAmp,"G1_gAmp_D12mm_");
	printVector(G2.gAmp,"G2_gAmp_D12mm_");
	printVector(G1.gGrid,"G1_gGrid_D12mm_");
	printVector(G2.gGrid,"G2_gGrid_D12mm_");
